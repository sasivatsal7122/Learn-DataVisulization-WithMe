...
yup that's it for now, you are free to download the release or click <a href="https://github.com/sasivatsal7122/Learn-DataVisulization-WithMe/archive/refs/tags/v1-alpha.zip">HERE</a> to download zip or go on to the <a href="https://www.kaggle.com/sasivatsal">kaggle</a> and find my notebooks there. On kaggle you can directly run the notebok via internet and you're system resources. 
